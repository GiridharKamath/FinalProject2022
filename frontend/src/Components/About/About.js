      ...
      <React.Fragment>
        ...
        <AboutUsWrapper id="about" >
          ...
          <p className="about__subtitle">
            ...
            helping them fill tables since 2019. Welcome to CREAMHUB</p>
          <div className="wrapper">

            <div className="the__history">
              <div className="about__content">
                <h5 >ICECREAM</h5>
                <p>The <span className="gold">ICECREAM :</span> Ice cream is sweet, and is usually flavored with fruit, spices, or candy- the flavor often influences the color (that is, chocolate ice cream is brown, strawberry and cherry flavors are pink, pistachio is green). Good ice cream has a smooth texture. Your ice cream should be cold, unless you like ice cream soup.

Ice cream comes frozen in a container, which usually has a smooth or rippled surface. Scooping it out of the container produces balls or curls of ice cream.</p>
            ...
            <div className="the__kitchens">
              ...
              <div className="kitchens-content">
                <p>The <span className="gold">CREAMHUB</span> gives its customers delicious flavored icecream with all richness and also provide sandwiches,fries etc at very reasonable price.It is a main reason why it attracted people all over karkala and also some part of karavali.Due to freshness of food people will get cravings to visit this place without fail when they move via karkala </p>
                <p>The creamhub not only provides dine in facility but also provides home delivery.It played crucial role in delivering food to people when they cannot get out of house during lockdown and satisfied their cravings.</p>
              </div>
            </div>
